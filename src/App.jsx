...
export class App extends Component {
  ...
  onButtonClikRender = e => {
    ...
    fetchImages(searchName, searchPage)
      ...
      .then(imagesNext =>
        this.setState({
          images: [...this.state.images, ...imagesNext.hits],
          numberPage: searchPage,
          spinerView: false,
        })
      );
  };
  ...
  render() {
    ...
    return (
      <div className={css.App}>
        ...
        {images !== null && <Button onClick={this.onButtonClikRender} />}
        {showModal && (
          <Modal imageForModal={largeImgForModal} onClose={this.toggleModal} />
        )}
      </div>
    );
  }
